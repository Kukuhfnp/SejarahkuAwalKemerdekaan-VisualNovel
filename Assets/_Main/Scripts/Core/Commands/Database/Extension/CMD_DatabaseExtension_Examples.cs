...
namespace TESTING
{
    public class CMD_DatabaseExtension_Examples : CMD_DatabaseExtension
    {
        ...
        {
            //Menambahkan action tanpa sebuah parameter
            ...
            //Menambahkan lambda tanpa parameter
            ...
            //Menambahkan coroutine tanpa parameter 
        ...
        //     //Ambil variable yang dibutuhkan, akan di define di tempat lain
        ...
        //     {
        //         currentX = Mathf.MoveTowards(currentX, targetX, moveSpeed = Time.deltaTime * 10);
