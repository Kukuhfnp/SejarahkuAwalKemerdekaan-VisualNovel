...
namespace COMMANDS
{
    public class CommandParameters
    {
        ...
        public bool TryGetValue<T>(string paramaterName, out T value, T defaultValue = default(T)) => TryGetValue(new string[] {paramaterName}, out value, defaultValue); 
        public bool TryGetValue<T>(string[] paramaterNames, out T value, T defaultValue = default(T))
        {
