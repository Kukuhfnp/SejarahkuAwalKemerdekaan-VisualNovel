...
{   
    ...
    public class VNGameSave
    {
        ...
        public static VNGameSave Load(string filePath, bool activeOnLoad = false)
        {
        ...
        public void Activate()
        {
            ...
            DialogueSystems.instance.prompt.Hide();
        }

        private string[] GetConversationData()
        {
            List<string> retData = new List<string>();
            var conversations = DialogueSystems.instance.conversationManager.GetConversationQueue();
        ...
        private void SetConversationData()
        {
            for (int i = 0; i < activeConversations.Length; i++)
            {
                try
                {
                    ...
                    {
                        if (i == 0)
                            DialogueSystems. instance. conversationManager. StartConversation(conversation);
                        else
