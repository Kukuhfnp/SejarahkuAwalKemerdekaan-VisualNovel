...
namespace CHARACTERS
{
    public abstract class Character
    {
        ...
        public DialogueSystems dialogueSystems => DialogueSystems.instance;

        //Coroutine
        protected Coroutine co_revealing, co_hiding; //co for Coroutine
        ...
        {
            dialogueSystems.ShowSpeakerName(name);
            UpdateTextCustomizationsOnScreen();
            return dialogueSystems.Say(dialogue);
        }
        ...
        public void UpdateTextCustomizationsOnScreen() => dialogueSystems.ApplySpeakerDataToDialogueContainer(config);
